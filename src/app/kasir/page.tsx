...
export default function KasirPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-8rem)]">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-white"><TranslatedText tKey="pos.title" /></h1>
        <p className="text-slate-400 mt-1"><TranslatedText tKey="pos.subtitle" /></p>
      </div>
      
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 min-h-0">
        {/* Kiri: Pencarian Santri (Lebar 5 dari 12 kolom) */}
        <div className="lg:col-span-5 h-full overflow-hidden flex flex-col bg-[#0f172a] text-white rounded-xl border border-slate-700 shadow-2xl p-4">
          <KasirSearch 
        ...
        <div className="lg:col-span-7 h-full overflow-hidden bg-[#0f172a] text-white rounded-xl border border-slate-700 shadow-2xl">
