...
export default function UpdateSoftwarePage() {
  ...
  return (
    <div className="min-h-screen bg-[#060b14] p-6 lg:p-10 text-white font-sans overflow-x-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-slate-900 to-[#0b1120] border border-slate-800 shadow-2xl p-8">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-amber-400 to-orange-600 flex items-center justify-center shadow-[0_0_40px_rgba(245,158,11,0.3)] mb-6">
                <RefreshCw size={40} className={`text-white ${isChecking ? 'animate-spin' : ''}`} />
              </div>
              
              <h2 className="text-2xl font-bold text-white mb-2">Versi Saat Ini: v1.2.0</h2>
              <p className="text-slate-400 mb-8 px-4">Stable Edition (LTS) - Dirilis pada Juli 2026</p>
              ...
              <button 
                ...
                className={`w-full group relative flex items-center justify-center gap-3 px-6 py-4 rounded-xl text-base font-semibold transition-all duration-300 overflow-hidden ${
                  isChecking 
                    ...
                    : 'bg-gradient-to-r from-amber-500 to-orange-600 text-white hover:shadow-[0_0_30px_rgba(245,158,11,0.4)] hover:-translate-y-1'
                }`}
              >
                {!isChecking && (
          ...
          <div className="p-6 rounded-2xl bg-[#0b1120] border border-slate-800/60 shadow-lg flex gap-4">
            <div className="mt-1 w-10 h-10 rounded-full bg-blue-500/10 flex items-center justify-center flex-shrink-0 text-blue-400">
              <Shield size={20} />
            </div>
            <div>
              <h3 className="font-semibold text-white mb-1">Keamanan Terjamin</h3>
              <p className="text-sm text-slate-400 leading-relaxed">Semua file update dienkripsi dan didistribusikan melalui server aman satujalan.id. Tidak ada risiko kehilangan data.</p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7">
          <div className="rounded-3xl bg-[#0b1120] border border-slate-800 shadow-2xl overflow-hidden h-full">
            ...
            <div className="p-8 space-y-10">
                ...
                <div className="space-y-6">
                  <div className="bg-slate-900/50 rounded-xl p-5 border border-slate-800/50 hover:border-slate-700 transition-colors">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="p-2 rounded-lg bg-blue-500/20 text-blue-400"><Bot size={18} /></div>
                      <h4 className="font-semibold text-white text-lg">AI Function Calling (Akses Kepsek)</h4>
                    </div>
                    <p className="text-slate-400 text-sm leading-relaxed mb-4">
                      Revolusi kecerdasan buatan! AI kini tidak hanya menjawab santai, tapi dilengkapi kapabilitas <span className="text-white font-medium">Function Calling</span>. AI secara otomatis membaca data <i>real-time</i> dari database jika di-chat oleh nomor WhatsApp Kepala Sekolah atau Admin.
                    </p>
                  ...
                  <div className="bg-slate-900/50 rounded-xl p-5 border border-slate-800/50 hover:border-slate-700 transition-colors">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h4 className="font-semibold text-white text-lg">Proteksi Database (Anti-Uninstall)</h4>
                    </div>
                    <p className="text-slate-400 text-sm leading-relaxed mb-4">
              ...
              {/* Release 1.1.0 */}
              <div className="relative pl-8 border-l border-slate-800 opacity-60">
                ...
                <p className="text-slate-400 text-sm mb-3">Pembaruan stabilisasi performa dan fitur dasar.</p>
                <ul className="text-sm text-slate-400 space-y-2">
