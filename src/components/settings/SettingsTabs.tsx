...
export function SettingsTabs({ initialData, isGuest = false }: { initialData: Record<string, string>, isGuest?: boolean }) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <Tabs defaultValue={isGuest ? "ai" : "umum"} className="w-full flex-col">
          <TabsList className={`flex flex-nowrap ${isGuest ? 'md:grid-cols-1' : 'md:grid md:grid-cols-4'} h-auto w-full mb-6 bg-white dark:bg-[#0f172a] gap-2 p-2 rounded-xl border border-slate-200 dark:border-slate-800 overflow-x-auto overflow-y-hidden snap-x scrollbar-hide justify-start`}>
            {!isGuest && <TabsTrigger value="umum" className="shrink-0 min-w-[140px] md:w-full py-2.5 rounded-lg text-slate-700 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white data-active:bg-orange-600 dark:data-active:bg-blue-600 data-active:text-white data-active:shadow-[0_0_15px_rgba(234,88,12,0.5)] dark:data-active:shadow-[0_0_15px_rgba(37,99,235,0.5)] data-active:border-orange-500 dark:data-active:border-blue-500 border border-transparent transition-all whitespace-nowrap h-full text-xs sm:text-sm snap-center">{t("settings.tab_general")}</TabsTrigger>}
            {!isGuest && <TabsTrigger value="keuangan" className="shrink-0 min-w-[140px] md:w-full py-2.5 rounded-lg text-slate-700 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white data-active:bg-orange-600 dark:data-active:bg-blue-600 data-active:text-white data-active:shadow-[0_0_15px_rgba(234,88,12,0.5)] dark:data-active:shadow-[0_0_15px_rgba(37,99,235,0.5)] data-active:border-orange-500 dark:data-active:border-blue-500 border border-transparent transition-all whitespace-nowrap h-full text-xs sm:text-sm snap-center">{t("settings.tab_payment")}</TabsTrigger>}
            <TabsTrigger value="ai" className="shrink-0 min-w-[140px] md:w-full py-2.5 rounded-lg text-slate-700 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white data-active:bg-orange-600 dark:data-active:bg-blue-600 data-active:text-white data-active:shadow-[0_0_15px_rgba(234,88,12,0.5)] dark:data-active:shadow-[0_0_15px_rgba(37,99,235,0.5)] data-active:border-orange-500 dark:data-active:border-blue-500 border border-transparent transition-all whitespace-nowrap h-full text-xs sm:text-sm snap-center">{t("settings.tab_ai")}</TabsTrigger>
            {!isGuest && <TabsTrigger value="penagihan" className="shrink-0 min-w-[140px] md:w-full py-2.5 rounded-lg text-slate-700 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white data-active:bg-orange-600 dark:data-active:bg-blue-600 data-active:text-white data-active:shadow-[0_0_15px_rgba(234,88,12,0.5)] dark:data-active:shadow-[0_0_15px_rgba(37,99,235,0.5)] data-active:border-orange-500 dark:data-active:border-blue-500 border border-transparent transition-all whitespace-nowrap h-full text-xs sm:text-sm snap-center">{t("settings.tab_billing")}</TabsTrigger>}
          </TabsList>
