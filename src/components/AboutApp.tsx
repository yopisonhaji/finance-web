...
export function AboutApp() {
  ...
  return (
    <div className="flex-1 max-w-md ml-8 relative hidden md:flex items-center group">
      <Dialog>
        <DialogTrigger className="relative flex items-center gap-2 px-4 py-2 rounded-full bg-[#151c2c] border border-slate-700/50 text-slate-400 hover:text-white hover:bg-slate-800/80 hover:border-slate-600 focus-visible:ring-indigo-500/50 focus-visible:border-indigo-500/50 transition-all shadow-inner">
          <Info className="w-4 h-4 text-indigo-400" />
          <span className="text-sm font-medium">Tentang Aplikasi</span>
        </DialogTrigger>
        <DialogContent className="sm:max-w-xl bg-[#0f172a] text-slate-200 border-slate-700 p-0 overflow-hidden" showCloseButton={true}>
          <div className="bg-gradient-to-br from-indigo-900/40 to-slate-900 p-6 border-b border-slate-800">
            <DialogHeader>
              ...
              <DialogDescription className="text-slate-400 mt-2 text-sm leading-relaxed max-w-md">
          ...
          <div className="p-6 max-h-[60vh] overflow-y-auto space-y-6 text-sm">
            ...
            <div className="flex gap-4 items-start">
              <div className="w-10 h-10 rounded-full bg-blue-500/10 flex items-center justify-center shrink-0 border border-blue-500/20 mt-0.5">
                <LifeBuoy className="w-5 h-5 text-blue-400" />
              </div>
              <div>
                <h4 className="font-semibold text-slate-200 text-base">Bantuan & Tutorial</h4>
                <p className="text-slate-400 mt-1 mb-2">Butuh panduan penggunaan aplikasi, dokumentasi API, atau bantuan teknis?</p>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <ul className="text-slate-400 mt-2 list-disc pl-4 space-y-1.5">
