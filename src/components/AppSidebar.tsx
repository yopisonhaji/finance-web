        ...
        <div className="relative overflow-hidden rounded-xl bg-[var(--color-dash-panel)] border border-slate-800/40 p-5 mt-auto">
          ...
          <div className="relative z-10 text-center space-y-3">
            ...
            <div className="pt-3 mt-3 border-t border-slate-700/50">
              ...
              <p className="text-[10px] text-slate-400 font-semibold mt-2 tracking-wide uppercase">
                Powered by <a href="https://satujalan.id" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors">satujalan.id</a>
              </p>
            </div>
          </div>
        </div>
